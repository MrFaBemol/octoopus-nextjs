...
export default function NavbarMain(){
    ...
    return (
        <header className="antialiased sticky top-0 z-50 shadow-md">
                ...
                <div className="flex flex-wrap justify-between items-center">
                    <div className="flex justify-start items-center">
                        ...
                        <a href="/" className="flex mr-4">
                            <Image src="/img/logo.png" width={0} height={0} sizes="2.3rem" style={{ width: 'auto', height: 'auto' }} className="mr-2 h-6 sm:h-9" alt="Octoopus Logo" />
